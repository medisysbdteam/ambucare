                ...
                if(btnType == 0) {
                   ...
                   // String password = mPasswordView.getText().toString();
                    PhoneAuthProvider.getInstance().verifyPhoneNumber(
                            ...
                            AuthActivity.this,
                            mCallBack// Activity (for callback binding)
                    );
                }
                else{
                // mSendBtn.setEnabled(false);
                 String verificationCode = mPasswordView.getText().toString();
...
mCallBack = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
    ...
    public void onVerificationFailed(FirebaseException e) {
        mError.setText("There was some error!");
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                           ...
                           // if(!isServiceRunning(LocationTService.class)){
                                Intent intent = new Intent(AuthActivity.this, LocationTService.class);
                                startService(intent);
                                finish();
                           // }
                        } else {
