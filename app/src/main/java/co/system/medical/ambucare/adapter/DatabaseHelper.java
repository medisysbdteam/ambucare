package co.system.medical.ambucare.adapter;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String PRODUCTS_PACKSIZE = "packSize";
    private static final String PRODUCTS_GROUP = "groupName";
...
//        values.put(PRODUCTS_PACKSIZE,aProducts_DB.GetPackSize());
//        values.put(PRODUCTS_GROUP,aProducts_DB.GetGroupName());
...
//                aProducts_DB.SetPackSize(c.getString(c.getColumnIndex(PRODUCTS_PACKSIZE)));
//                aProducts_DB.SetGroupName(c.getString(c.getColumnIndex(PRODUCTS_GROUP)));
